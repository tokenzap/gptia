...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código ZapSeller...${GRAY_LIGHT}"
  printf "\n\n"
...
system_unzip_Multizap() {
  print_banner
  printf "${WHITE} 💻 Extraindo o ZapSeller...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema ZapSeller...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do ZapSeller...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Bloquear o ZapSeller...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o ZapSeller de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do ZapSeller de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
