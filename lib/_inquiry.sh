...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador ZapSeller, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar ZapSeller\n"
  printf "   [1] Atualizar ZapSeller\n"
  printf "   [2] Deletar ZapSeller\n"
  printf "   [3] Bloquear ZapSeller\n"
  printf "   [4] Desbloquear ZapSeller\n"
  printf "   [5] Alter. dominio ZapSeller\n"
  printf "\n"
  read -p "> " option
